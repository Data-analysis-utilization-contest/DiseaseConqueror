...
def modeling(data, target, models=['RandomForest', 'AdaBoost', 'GradientBoosting', 'XGBoost', 'LightGBM', 'CatBoost'], one_hot_encoding=True, n_splits=5, test_size=0.33, random_state=42, save=True, prePath=None):
    """
        학습하기
...
def factor_extraction(data, target, models=['RandomForest', 'AdaBoost', 'GradientBoosting', 'XGBoost', 'LightGBM', 'CatBoost'], one_hot_encoding=True, n=40, random_state=42, visualization=False):
    """
        영향 요인 추출
...
if __name__=='__main__':
    ...
    parser.add_argument('-models', nargs='+', choices=['RandomForest', 'AdaBoost', 'GradientBoosting', 'XGBoost', 'LightGBM', 'CatBoost'], help='Choose a machine learning model to train on')
